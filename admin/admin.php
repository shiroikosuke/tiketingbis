	...
	<div class="wrapper">
		<nav class="navbar navbar-default navbar-fixed-top" rol="navigation" style="background: #3e5e91">
			<div class="navbar-header">
			    ...
			    <a class="navbar-brand" style="color: #f9ecf2">Halaman Admin Aplikasi Pembelian Tiket Bus</a>
			</div>
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav" style="background: #3e5e91">
					...
					<li>
						<a href="admin.php?halaman=bukti_bayar" style="color: #FFFFFF"><span class="glyphicon glyphicon-download-alt">&nbsp;</span>Konfirmasi Pembayaran</a>
					</li>
					<li>
