...
<br>
    ...
    <form class="form-horizontal" action="config/proses_pesan.php" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="date" name="tgl_berangkat" class="form-control input-md" required/>
            </div>
        </div>
        <div class="form-group">
    ...
    <!-- <form class="form-horizontal" action="config/doPesan.php" method="POST">
                <div class="form-group">
                  <label class="col-sm-1"></label>
                  <label class="col-sm-3">Nama Lengkap</label>
                  <label class="col-sm-1">:</label>
                  <div class="col-sm-6">
                    <input class="form-control" name="nama" type="text" value="<?php echo $_SESSION['nama']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-1"></label>
                  <label class="col-sm-3">TTL</label>
                  <label class="col-sm-1">:</label>
                  <div class="col-sm-6">
                    <input class="form-control" name="nama" type="text" value="<?php echo $_SESSION['nama']; ?>">
                  </div>
